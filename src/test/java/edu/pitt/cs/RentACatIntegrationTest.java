...
public class RentACatIntegrationTest {
	...
	public void testRentCatNumCats3() {
		...
		assertEquals(c2.getName()+ " has been rented.\n", out.toString());
	}
	...
	public void testRentCatFailureNumCats3() {
		...
		assertFalse(ret);
		assertTrue(c2.getRented());
		assertEquals("Sorry, "+c2.getName()+" is not here!\n", out.toString());	
	}
	...
	public void testReturnCatNumCats3() {
		...
		assertEquals("Welcome back, "+c2.getName()+"!\n", out.toString());
	}
	...
	public void testReturnFailureCatNumCats3() {
		...
		assertFalse(ret);
		assertFalse(c2.getRented());
		assertEquals(c2.getName() + " is already here!\n", out.toString());
	}
}